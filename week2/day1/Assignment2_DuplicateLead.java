...
public class Assignment2_DuplicateLead {
	...
	public static void main(String[] args) {
		...
		elementCompanyNameClear.sendKeys("Tesla");
		WebElement elementFirstNameClear = driver.findElement(By.id("createLeadForm_firstName"));
		elementFirstNameClear.clear();
		elementFirstNameClear.sendKeys("Cat");
		WebElement elementClickCreate1 = driver.findElement(By.className("smallSubmit"));
		elementClickCreate1.click();
		if(driver.getTitle().contains("View Lead")){
			System.out.println("I confirm the title has View Lead");
